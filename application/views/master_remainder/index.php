            ...
            <div class="page-header page-header-light">
               <div class="page-header-content header-elements-md-inline">
                  <div class="page-title d-flex">
                     <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Master Remainder</span></h4>
                  ...
                  <div class="col-md-6">
                     ...
                     <div class="card">
                        <div class="card-header header-elements-inline">
                           <h5 class="card-title">Master Remainder</h5>
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="<?php echo base_url(); ?>client-master/save-client-master" >
                                <div class="form-group">
                                 <label>Remainder Person Name</label>
